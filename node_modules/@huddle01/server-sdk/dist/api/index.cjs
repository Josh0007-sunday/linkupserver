...
var API = class {
  ...
  createRoom = async (data) => {
    try {
      ...
      if (data?.metadata && chunkNJUEGIAO_cjs.estimateSize(data.metadata) > chunkCGGVUTEY_cjs.MAX_ROOM_METADATA_SIZE) {
  ...
  getPartipantsDetails = async (data) => {
    try {
      const resp = await this.#infraClient.api.v2.sdk.rooms["participant-list"].$get({
        query: {
